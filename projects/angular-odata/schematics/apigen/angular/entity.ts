...
{
    constructor(options: ApiGenSchema, protected edmType: CsdlEntityType | CsdlComplexType) {
        super(options);
    } 
    ...
    public override fileName() {
        return strings.dasherize(this.edmType.name()) + (this.edmType instanceof CsdlEntityType ? ".entity" : ".complex")
    } 
