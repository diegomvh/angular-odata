...
{
    constructor(options: ApiGenSchema, protected edmElement: CsdlEntitySet | CsdlEntityContainer | CsdlSingleton) { 
        super(options);
    }
    public override template(): Source {
        return this.edmElement instanceof CsdlEntitySet ? url("./files/entityset-service") :
            this.edmElement instanceof CsdlSingleton ? url("./files/singleton-service") :
    ...
    public entityType() {
        return (this.edmElement instanceof CsdlEntitySet) ? this.edmElement.EntityType : 
        this.edmElement instanceof CsdlSingleton ? this.edmElement.Type : '';
    }
