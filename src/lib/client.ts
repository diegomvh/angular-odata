...
export class ODataClient {
		...
		switch(options.observe || 'body') {
			case 'body':
				switch(options.responseType) {
					case 'entity':
						return res$.pipe(map((body: any) => schema.deserialize(body)));
					case 'entityset':
				...
				switch(options.responseType) {
					case 'entity':
						return res$.pipe(map((res: HttpResponse<any>) => new HttpResponse<any>({
							body: schema.deserialize(res.body), 
							headers: res.headers, 
							status: res.status, 
	...
	delete (req: ODataRequest<any>, etag?: string, options?: {
		headers?: HttpHeaders | {[header: string]: string | string[]},
		observe?: 'body',
		params?: HttpParams|{[param: string]: string | string[]},
		reportProgress?: boolean,
	...
	delete<T>(req: ODataRequest<any>, etag?: string, options?: {
		headers?: HttpHeaders | {[header: string]: string | string[]},
		observe: 'events',
		params?: HttpParams|{[param: string]: string | string[]},
		reportProgress?: boolean,
	...
	patch(req: ODataRequest<any>, body: any|null, etag?: string, options?: {
		headers?: HttpHeaders | {[header: string]: string | string[]},
		observe?: 'body',
		params?: HttpParams|{[param: string]: string | string[]},
		reportProgress?: boolean,
	...
	patch<T>(req: ODataRequest<any>, body: any|null, etag?: string, options?: {
		headers?: HttpHeaders | {[header: string]: string | string[]},
		observe: 'events',
		params?: HttpParams|{[param: string]: string | string[]},
		reportProgress?: boolean,
	...
	put(req: ODataRequest<any>, body: any|null, etag?: string, options?: {
		headers?: HttpHeaders | {[header: string]: string | string[]},
		observe?: 'body',
		params?: HttpParams|{[param: string]: string | string[]},
		reportProgress?: boolean,
	...
	put<T>(req: ODataRequest<any>, body: any|null, etag?: string, options?: {
		headers?: HttpHeaders | {[header: string]: string | string[]},
